...
const total = receita.reduce((resultado, quantidade) => {
    return (resultado + quantidade.valor);
}, 0);

console.log("O valor total de vendas sem gorjeta é: " + total) 


//Problema 2: Qual o valor total de vendas incluindo a gorjeta?
//COLOQUE SUA SOLUÇÃO AQUI

const gorjeta = receita.reduce((resultado, quantidade) => {
    return (resultado + quantidade.gorjeta + quantidade.valor);
}, 0);

console.log("O valor total de vendas com gorjeta é: " + gorjeta) 


//Problema 3: Quantas vendas foram abaixo de 50 reais?
//COLOQUE SUA SOLUÇÃO AQUI

const count = receita.filter(item => item.valor < '50').length

console.log("A quantidade de vendas abaixo de 50 reais foram: " + count)